...
void setup() {
  ...
  delay(1000);
  //boolean bJunk = processCommands("HELLO DE " + gsCallSign);
  //gsMorse = convertToMorse("QNI" + gsCallSign);
} // Nothing to setup, just start playing!


void keyDit() {
  // pin has changed. set led to pin state
  //while (digitalRead(pinKEY_DIT) == LOW) {
